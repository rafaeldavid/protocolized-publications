---
id: source-gates-internet-tidal-wave-1995-full-text
companion_to: gates-internet-tidal-wave-1995.md
date_observed: 1995-05-26
date_added: 2026-04-26
source_quality: primary
status: active
sources:
  - url: https://www.justice.gov/sites/default/files/atr/legacy/2006/03/03/20.pdf
    title: "United States v. Microsoft — Government Exhibit 20 (the original DOJ-published scan)"
  - url: https://lettersofnote.com/2011/07/22/the-internet-tidal-wave/
    title: "Letters of Note — clean transcription by Shaun Usher (2011)"
local_artifacts:
  - sources/Gates-Internet-Tidal-Wave-1995-DOJ-GX20.pdf
maintainer: rafa
---

# Bill Gates — *The Internet Tidal Wave* (May 26, 1995) — full text

This is the full text of Bill Gates's internal Microsoft memo *The Internet Tidal Wave*, dated May 26, 1995, sent to Microsoft's Executive Staff and direct reports. The memo was internal at the time and entered the public record as **Government Exhibit 20** in *United States v. Microsoft Corporation* (the antitrust trial, 1998–2001). It is widely considered one of the most consequential internal documents in tech history: the moment Microsoft formally re-oriented around the internet.

**The companion research entry** with summary, citable claims, and CMM-relevance commentary is at [gates-internet-tidal-wave-1995.md](gates-internet-tidal-wave-1995.md).

**Local primary artifact:** [`sources/Gates-Internet-Tidal-Wave-1995-DOJ-GX20.pdf`](sources/Gates-Internet-Tidal-Wave-1995-DOJ-GX20.pdf) — the original 9-page DOJ scan.

**Transcription source:** Cross-checked between the local DOJ scan (OCR-grade) and the Letters of Note transcription. Where the scan is unclear and the published transcription supplies a reading, the published reading is used. Editorial corrections of obvious 1995-era typos (e.g., *commumcatiom* → *communication*) are silent. Bracketed `[...]` indicates illegible text. Section headers are reproduced as in the original.
...
Browsing the Web, you find almost no Microsoft file formats. After 10 hours of browsing, I had not seen a single Word .DOC, AVI file, Windows .EXE (other than content viewers), or other Microsoft file format. I did see a great number of Quicktime files. All of the movie studios use them to offer film trailers. Apple benefited by having TCP support before we did and is working hard to build a browser that builds from OpenDoc components. Apple will push for OpenDoc protocols to be used on the Internet, and is already offering good server configurations. Apple's strength in education gives them a much stronger presence on the Internet than their general market share would suggest.
...
- *Affordable Computing*: advertising subsidized hardware — by Nicholas Negroponte
- Brief Lecture Notes on VRML & Hot Java — email by William Barr
- Notes from a Lecture by Mark Andreessen (Netscape) — email by William Barr
...
A second copy of these links is below as Word HTML links. *To use these links, you must be running the Word Internet Assistant, and be connected to the Web.*
...
*End of memo. Document carries internal classifications M 1028049–1028057 and MS98 0112876.1–0112876.8 ("CONFIDENTIAL"). Headers on each page after the first read* "Bill Gates / May 26 1995 / The Internet Tidal Wave" *with the file path footer* `\\lincoln_bu\public\web\itw.doc`*. Government Exhibit 20 stamp on page 1.*
