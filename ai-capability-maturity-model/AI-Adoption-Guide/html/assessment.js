...
(function () {
  ...
  const RESULTS = {
    ...
    '3': {
      ...
      actions: [
        { name: 'Measure and address schedule dislocation', description: 'Calculate the Slacker Index for your primary AI workflow: total lead time ÷ AI working time. Where the ratio exceeds 5:1, identify the downstream coordination bottleneck (review queue, approval chain, handoff delay) and redesign the coordination protocol.', doneWhen: 'Slacker Index below 5:1 for primary workflow; bottleneck owner named.' },
