...
Before selecting a candidate use case, do an audit of what is already in motion. Most organizations are already at Level 1 — they simply cannot see it. The audit is likely a half-day exercise per function and does three things.
...
> ### Note on this chapter *(placeholder — v0.5)*
>
